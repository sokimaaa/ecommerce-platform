...
import com.sokima.specification.rest.inventory.explore.v1.api.InventoryExplorationReactiveApi;
import com.sokima.specification.rest.inventory.explore.v1.response.InventoryExplorationResponse;
import com.sokima.specification.rest.inventory.manage.v1.api.InventoryManagementReactiveApi;
import com.sokima.specification.rest.inventory.manage.v1.request.InventoryAllocationRequest;
import com.sokima.specification.rest.inventory.manage.v1.request.InventorySupplementRequest;
import com.sokima.specification.rest.inventory.manage.v1.response.InventoryAllocationResponse;
import com.sokima.specification.rest.inventory.manage.v1.response.InventorySupplementResponse;
